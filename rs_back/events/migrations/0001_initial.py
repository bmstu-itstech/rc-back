...
import rs_back.events.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('searcher_fio', models.CharField(max_length=150, validators=[rs_back.events.validators.ValidateFullName()], verbose_name='фио участника')),
                ('searcher_bmstu_group', models.CharField(max_length=15, validators=[rs_back.events.validators.ValidateGroup()], verbose_name='учебная группа')),
